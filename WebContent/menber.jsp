...
<td><input type="text" id="id" name="id" value=<%=session.getAttribute("existUser4")%> readonly="readonly" style="width:99.5%;height:100%;font-size:70%;text-align: center; " ></td>
